...
def scrypt_hash(password):
    scrypt.hash(password, b'salt', N=2**14, r=8, p=5)
...
def times_and_plot():
    ...
    hash_funcs = [argon2_hash, bcrypt_hash, pbkdf2_hash, scrypt_hash]
    avg_times = []
    avg_memories = []
    ...
    plt.title('Average Execution Time and Memory Usage of Hashing One Password')
    # plt.show()
